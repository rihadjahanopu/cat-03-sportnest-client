...
export default function Newsletter() {
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="glass p-10 md:p-16 rounded-3xl border border-card-border/60 relative overflow-hidden shadow-2xl">
        {/* Glow Effects */}
          ...
          <form onSubmit={handleSubscribe} className="pt-4 max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-grow bg-secondary/50 border border-card-border rounded-xl px-5 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm placeholder-gray-500"
              />
              <button
                type="submit"
                disabled={loading}
                className="bg-primary hover:bg-primary-dark text-secondary font-bold px-8 py-4 rounded-xl transition-all shadow-[0_0_15px_rgba(57,255,20,0.3)] hover:shadow-[0_0_25px_rgba(57,255,20,0.5)] flex items-center justify-center gap-2 text-sm disabled:opacity-50"
              >
