  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        ...
        <p className="text-gray-400">Manage your upcoming and past bookings.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          {visibleBookings.map((booking) => (
            <div key={booking._id} className="glass p-6 rounded-2xl flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="w-full md:w-auto mt-4 md:mt-0 flex-shrink-0">
                {booking.status !== 'cancelled' ? (
                  <button
                    ...
                    className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-lg border border-red-500/50 text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-colors disabled:opacity-50 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-lg border border-gray-500 text-gray-400 hover:bg-gray-500/10 hover:text-white transition-colors cursor-pointer"
                  >
