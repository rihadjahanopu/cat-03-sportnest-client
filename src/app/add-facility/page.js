  ...
  const onSubmit = async (data) => {
    ...
    try {
      const payload = {
        ...
        available_slots: ["09:00", "10:00", "11:00", "12:00", "14:00", "15:00", "16:00", "17:00", "18:00"],
      };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {errors.facility_type && <p className="text-red-400 text-xs mt-1">{errors.facility_type.message}</p>}
            </div>
