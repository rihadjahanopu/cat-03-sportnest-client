    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass p-8 rounded-3xl border border-white/5 text-center flex flex-col items-center shadow-xl relative overflow-hidden">
            ...
            <p className="text-gray-400 text-sm mb-6 truncate max-w-full">{user.email}</p>
        ...
        <div className="lg:col-span-2">
          <div className="glass p-8 md:p-10 rounded-3xl border border-white/5 shadow-xl">
            <h3 className="text-3xl font-black mb-2">Profile Settings</h3>
            <p className="text-gray-400 mb-8">Keep your display name and avatar up to date for bookings and turf managers.</p>
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-secondary/50 border border-card-border rounded-xl pl-12 pr-4 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">Provide a valid image link to display your custom player avatar.</p>
              </div>
              ...
              <div className="pt-6 border-t border-white/5 flex gap-4">
                <button
                  type="button"
                  onClick={() => router.push("/")}
                  className="flex-1 bg-white/5 hover:bg-white/10 font-bold py-4 rounded-xl transition-colors"
                  disabled={updating}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 bg-primary hover:bg-primary-dark text-secondary font-bold py-4 rounded-xl transition-all shadow-[0_0_15px_rgba(57,255,20,0.3)] disabled:opacity-50"
                  disabled={updating}
                >
