  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        ...
        <p className="text-gray-400">View and manage the facilities you have listed.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {facilities?.map((facility) => (
            <div key={facility._id} className="glass rounded-2xl overflow-hidden flex flex-col transition-all hover:border-primary/50">
        ...
        <div className="text-center py-20 glass rounded-2xl">
          ...
          <p className="text-gray-400">You haven&apos;t listed any facilities yet.</p>
        </div>
      )}
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="glass p-8 rounded-2xl max-w-md w-full border border-card-border shadow-2xl">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 bg-white/5 hover:bg-white/10 font-bold py-3 rounded-xl transition-colors"
      ...
      {editFacility && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="glass p-8 rounded-2xl max-w-2xl w-full border border-card-border shadow-2xl my-8">
            <h3 className="text-3xl font-bold mb-2">Edit Facility</h3>
            <p className="text-gray-400 mb-6">Modify the details of your sports complex below.</p>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-6">
              ...
              <div className="flex gap-4 pt-4 border-t border-card-border">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-primary hover:bg-primary-dark text-secondary font-bold py-3 rounded-xl transition-all shadow-[0_0_15px_rgba(57,255,20,0.3)] disabled:opacity-50"
                  disabled={updateFacility.isPending}
                >
