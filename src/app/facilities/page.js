  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        ...
        <p className="text-gray-400">Discover and book the best sports venues around you.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-12">
        <div className="flex-grow relative">
          ...
          <input
            ...
            className="w-full bg-card border border-card-border rounded-xl pl-12 pr-4 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
            value={search}
            onChange={(e) => {
        ...
        <div className="w-full md:w-64 relative">
          ...
          <select
            className="w-full bg-card border border-card-border rounded-xl pl-12 pr-4 py-4 text-white appearance-none focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors relative z-0"
            value={type}
            onChange={(e) => {
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {data.facilities.map((facility) => (
              <div key={facility._id} className="glass rounded-2xl overflow-hidden flex flex-col group transition-all hover:border-primary/50">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-4 border-t border-card-border flex justify-between items-center">
                    <span className="text-sm text-gray-400 bg-white/5 px-2 py-1 rounded">{facility.facility_type}</span>
          ...
          {data?.pagination?.totalPages > 1 && (
            <div className="flex justify-center items-center gap-4">
              <button
                ...
                className="px-4 py-2 glass rounded-lg disabled:opacity-50 hover:bg-white/5 transition-colors"
              >
                Previous
              </button>
