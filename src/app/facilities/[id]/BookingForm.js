...
export default function BookingForm({ facility }) {
  ...
  return (
    <div className="glass p-8 rounded-2xl border-t-4 border-primary shadow-[0_10px_40px_rgba(57,255,20,0.1)]">
      <h3 className="text-2xl font-bold mb-2">Book a Slot</h3>
      <p className="text-gray-400 mb-6 text-sm">Select your preferred time and date.</p>
